...
const { AvailableAddOnContext } = require("twilio/lib/rest/preview/marketplace/availableAddOn.js");
// var ctrlWhastsapp = require("../controllers/whatsapp.controller");
// router
//   .route('/paynow')
...
router.route("/subscribe/toggle/status").post(ctrlUsers.subscribeToggleStatus);
router.route("/subscribe/toggle/status/get").post(ctrlUsers.subscribeToggleStatusGet);
...
router.route("/admin/getAll/product").post(ctrlProduct.GetAll);

router.route("/admin/updatePriority").post(ctrlProduct.editPriority);

router.route("/admin/getAllForPriority").post(ctrlProduct.getAllForPriority);
...
router.route("/conf/admin/product/:Id").get(auth.authenticateAdmin, ctrlProduct.GetOne2).delete(auth.authenticateAdmin, ctrlProduct.DeleteOne);
...
router.route("/category/GetAllActive").get(ctrlProductCategories.GetAllActive);
...
router.route("/payment/gateway/getAllActive").get(ctrlPaymentOptions.GetAll);
...
router.route("/admin/adminAddOne").post(ctrlAdmin.adminAddOne);
...
router.route("/admin/adminGetAll_for_sales_person").post(ctrlAdmin.adminGetAll_for_sales_person);
...
//region
router.route("/admin/getRegion").post(ctrlRegion.GetAll);
...
// role
router.route("/admin/getAllRole").post( ctrlRole.GetAll);

router.route("/admin/addRole").post(ctrlRole.AddOne);
...
// role modules
router.route("/admin/getRoleModules").post( ctrlRoleModule.GetAll);
...
router.route("/admin/DeleteOneInventoryItem").post(ctrlInventory.DeleteOneInventoryItem);
...
router.route("/AcceptFailedOrder").post(ctrlBooking.AcceptFailedOrder);
...
router.route("/wallet/addMoneyByRozarpay").post(ctrlWallet.addMoneyByRozarpay);
...
//products sample import/export
router.route("/admin/products/exportSampleXls").get(ctrlProduct.exportSampleXls);
router.route("/admin/products/importSampleXls").post(ctrlProduct.importSampleXls);
...
router.route("/products/correction").get(ctrlProduct.correction);
router.route("/products/qtycorrectionPI").get(ctrlProduct.qtycorrectionPI);

router.route("/products/getPackage").post(ctrlProduct.getPackageObj);
router.route("/products/createOrGetPackage").post(ctrlProduct.createOrGetPackage);

// router.route("/whatsapp/startConnection").get(ctrlWhastsapp.startConn);
// router.route("/whatsapp/checkStatus").get(ctrlWhastsapp.checkStatus);
// router.route("/whatsapp/sendTestMsg").get(ctrlWhastsapp.sendMsg);
// router.route("/whatsapp/stopConnection").get(ctrlWhastsapp.stopConn).post(ctrlWhastsapp.stopConn);
router.route("/updateRazorpayPaymentStatus").post(auth.authenticateUser, ctrlBooking.updateRazorpayPaymentStatus);
