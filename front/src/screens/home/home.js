        ...
        <div className="page-wrapper" style={{ position: "relative" }} onClick={() => document.querySelector(".header-bar").classList.remove("open")}>
          ...
          <main className="page-content">
            <section className="sidebar-layout">
              <aside className="side-left-col">
                {this.state.reRenderer ? (
                  <Sidebar
                    filterPass={() => {
                    ...
                    subscribe_status={this.state.status}
                    changeHeaderStatus={(e) => this.handleChangeStatus(e)}
                    selectedCategory={(e) => this.setState({ selectedCategory: e })}
                    closeMobileDropdown={this.state.closeMobileDropdown}
                  />
                ) : (
                  <Sidebar
              ...
              <div className="right-col-content" style={{ position: "relative" }}>
                <LoadingBar
                  color="#febc15"
