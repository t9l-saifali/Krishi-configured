...
export default class inhouselisting extends Component {
  constructor() {
    super();
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        <div className="manage_up_add_btn">
                          <h4 className="card-title"> Inhouse Inventory </h4>
                          <Link to="/add_inhouseusage">
                            <button
                              className="btn btn-primary m-r-5 float-right"
                              title="Add Inventory"
                            >
                              <i className="fa fa-plus"></i> Add In House
                              Product
                            </button>
                          </Link>
                        </div>
                ...
                <div className="row">
                  <div className="col-md-12 ml-auto mr-auto">
                    <div className="card">
                      ...
                      <div className="card-body">
                        <h4 className="card-title"> View In House </h4>
