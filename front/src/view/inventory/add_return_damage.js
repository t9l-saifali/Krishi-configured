      ...
      AdminApiRequest(data, "/admin/add/voucherInventory", "POST", "")
        .then((res) => {
          if (res.status === 201 || res.status === 200) {
            ...
            swal({
              title: "Success",
              text: "Return Inventory Added Successfully !",
              icon: "success",
              successMode: true,
            });
            this.props.history.push("/admin-return-inventory");
                ...
                <div className="col-md-12 ml-auto mr-auto">
                  <div className="card admin-form-stylewrp">
                    ...
                    <div className="card-body">
                      <h4 className="card-title"> Return</h4>
